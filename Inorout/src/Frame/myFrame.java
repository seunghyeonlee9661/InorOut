...
public class myFrame extends JFrame{
	...
	public JPanel sidePanelsetting(){
		...
		drawButton.addItemListener(new ItemListener() {public void itemStateChanged(ItemEvent e) {mod = 1;}});  
		pointButton.addItemListener(new ItemListener() {public void itemStateChanged(ItemEvent e) {mod = 2;}});        
		...
		runButton.addActionListener(new ActionListener() {			
			...
			public void actionPerformed(ActionEvent e) {
				...
				//교차점의 개수가 홀수일 경우 내부				
				if(cross%2 > 0) infoLabel.setText("내부!");
				//교차점의 개수가 짝수일 경우 외부					
				else infoLabel.setText("외부!");		
			}
		});	
